...
export function LoginForm() {
  ...
  return (
    <div className="w-full rounded-3xl border border-line bg-surface p-5 shadow-card md:p-7">
      <div className="mb-6">
      ...
      <form className="grid gap-4" onSubmit={handleLogin}>
        <label className="grid gap-2 text-sm font-bold text-ink">
          Email
          <span className="flex items-center gap-3 rounded-2xl border border-line bg-elevated px-4 py-3 focus-within:border-primary/60 focus-within:bg-surface">
        ...
        <button className="mt-2 rounded-2xl bg-primary px-5 py-3.5 text-sm font-black text-canvas shadow-glow transition hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60" disabled={isPending} type="submit">
